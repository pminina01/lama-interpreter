...
public class PrettyPrinter
{
  ...
  private static void pp(lama.Absyn.Stm foo, int _i_)
  {
    ...
    else     if (foo instanceof lama.Absyn.SReturn)
    {
       lama.Absyn.SReturn _sreturn = (lama.Absyn.SReturn) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("return");
       pp(_sreturn.exp_, 0);
       render(";");
    ...
    else     if (foo instanceof lama.Absyn.SImp)
    {
       lama.Absyn.SImp _simp = (lama.Absyn.SImp) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("import");
       printQuoted(_simp.string_);
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void sh(lama.Absyn.Stm foo)
  {
    ...
    if (foo instanceof lama.Absyn.SReturn)
    {
       lama.Absyn.SReturn _sreturn = (lama.Absyn.SReturn) foo;
       render("(");
       render("SReturn");
    ...
    if (foo instanceof lama.Absyn.SImp)
    {
       lama.Absyn.SImp _simp = (lama.Absyn.SImp) foo;
       render("(");
       render("SImp");
